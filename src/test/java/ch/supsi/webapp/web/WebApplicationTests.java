...
//				.andReturn();
//		id = (int)objectMapper.readValue(mvcResult.getResponse().getContentAsString(), Item.class).getId(); System.out.println(id);
//	}
//
//	@Test
//	// GET /blogpost -> size == 1
...
//				.andExpect(jsonPath("$.id").exists())
//				.andReturn();
//		id2 = (int)objectMapper.readValue(mvcResult.getResponse().getContentAsString(), Item.class).getId(); System.out.println(id);
//	}
//
//	@Test
//	// DELETE /blogpost/{id}
